...
public class LinkedNStackTest {
private LinkedNStack<String> S1;
	private LinkedNStack<String> S2;
	
	@Before
	public void setupFixture() {
		
		S1 = new LinkedNStack<String>(5);
		S1.push("A", "B", "C");
		
		S2 = new LinkedNStack<String>(10);
		S2.push("A", "B", "C");
	}
	...
	public void testDrops() {
		...
		LinkedNStack<String> S3 = new LinkedNStack<String>(5);
		S3.push("C", "D", "E", "F", "G");
